      ...
      <div className="container mx-auto px-6 max-w-6xl space-y-32">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-display font-black text-[#1F2937] mb-6 leading-tight">{steps[0].title}</h2>
            <p className="text-lg lg:text-xl text-[#64748B] font-medium leading-relaxed">{steps[0].description}</p>
          </motion.div>
          ...
          >
            <div className="w-[280px] sm:w-[320px] h-[580px] transform scale-90 lg:scale-100 origin-center pointer-events-none">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-display font-black text-[#1F2937] mb-6 leading-tight">{steps[1].title}</h2>
            <p className="text-lg lg:text-xl text-[#64748B] font-medium leading-relaxed">{steps[1].description}</p>
          </motion.div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-display font-black text-[#1F2937] mb-6 leading-tight">{steps[2].title}</h2>
            <p className="text-lg lg:text-xl text-[#64748B] font-medium leading-relaxed">{steps[2].description}</p>
          </motion.div>
